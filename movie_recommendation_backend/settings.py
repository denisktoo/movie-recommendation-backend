...
# Cache configuration — uses the same Redis instance as Celery
CACHES = {
    "default": {
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_PAGINATION_CLASS": "movie_recommendation.pagination.BasePagination",
    "PAGE_SIZE": 10,
    ...
    "DEFAULT_THROTTLE_RATES": {
        "anon": "100/day",
        "user": "1000/day",
        "recommendations": "20/hour",  # custom scope for expensive endpoints
    },
}
