...
from .views import (
    ...
    SearchHistoryViewSet, RecommendationCacheViewSet, RecommendationViewSet, RegisterView
)
...
routers.register(r'generated-recommendations', RecommendationViewSet, basename='generated-recommendations')
