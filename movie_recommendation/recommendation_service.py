...
from .models import (
    Movie, Favorite, Watchlist, Rating, SearchHistory, RecommendationCache
)
from .tmdb import search_movies, get_movie_recommendations
...
def recommend_from_ratings(user, limit=10):
    ...
    ranked_tmdb_ids = [
        tmdb_id for tmdb_id, _ in recommendation_counter.most_common()
